...
Feel free to check out the [releases](https://github.com/SQUIPIX/laravel-logViewer/releases), [license](LICENSE.md), and [contribution guidelines](CONTRIBUTING.md).

## Features

  - A great Log viewer API.
  - Laravel `9.x` to `12.x` are supported.
