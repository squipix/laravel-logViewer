...
namespace Squipix\LaravelLogViewer\Commands;

use Squipix\LaravelLogViewer\Contracts\LogViewer as LogViewerContract;
use Squipix\Support\Console\Command as BaseCommand;
...
abstract class Command extends BaseCommand
{
    ...
    protected function displayLogViewer()
    {
        ...
        // Copyright
        $this->comment('Version '.$this->logViewer->version().' - Created by SQUIPIX'.chr(169));
        $this->line('');
    }
}
