...
interface LogViewer extends Patternable
{
     ...
     * Get all logs.
     *
     * @return \Squipix\LaravelLogViewer\Entities\LogCollection|\Squipix\LaravelLogViewer\Entities\Log[]
     */
    public function all();
     ...
     * @return bool
     *
     * @throws \Squipix\LaravelLogViewer\Exceptions\FilesystemException
     */
