...
namespace Squipix\LaravelLogViewer\Entities;
...
class LogCollection extends LazyCollection
{
     ...
     *
     * @throws \Squipix\LaravelLogViewer\Exceptions\LogNotFoundException
     */
    ...
    public function stats()
    {
        ...
        foreach ($this->all() as $date => $log) {
            /** @var \Squipix\LaravelLogViewer\Entities\Log $log */
