...
You can install this package via [Composer](http://getcomposer.org/) by running this command: `composer require squipix/laravel-log-viewer:{x.x}` where **x.x** is the version compatible with your laravel's version. 
...
'providers' => [
    ...
    Squipix\LaravelLogViewer\LogViewerServiceProvider::class,
],
```
...
Go to `http://{your-project}/log-viewer` (See the [Configuration](https://github.com/SQUIPIX/LogViewer/wiki/3.-Configuration) page to change the uri and other stuff).
