...
use Squipix\LaravelLogViewer\Utilities\LogStyler;
...
class LogStylerTest extends TestCase
{
    ...
    /** @var  \Squipix\LaravelLogViewer\Utilities\LogStyler */
    private $styler;
    ...
    protected function setUp(): void
    {
        ...
        $this->styler = $this->app->make(\Squipix\LaravelLogViewer\Contracts\Utilities\LogStyler::class);
    }
