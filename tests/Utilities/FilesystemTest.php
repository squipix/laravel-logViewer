...
use Squipix\LaravelLogViewer\Utilities\Filesystem;
...
class FilesystemTest extends TestCase
{
    ...
    /** @var  \Squipix\LaravelLogViewer\Utilities\Filesystem */
    private $filesystem;
    ...
    {
        $this->expectException(\Squipix\LaravelLogViewer\Exceptions\FilesystemException::class);
