...
use Squipix\LaravelLogViewer\Utilities\Factory;
...
class FactoryTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->logFactory = $this->app->make(\Squipix\LaravelLogViewer\Contracts\Utilities\Factory::class);
    }
    ...
    {
        $expectations = [
            \Squipix\LaravelLogViewer\Contracts\Utilities\Filesystem::class,
            \Squipix\LaravelLogViewer\Utilities\Filesystem::class,
        ];
    ...
    {
        $expectations = [
            \Squipix\LaravelLogViewer\Contracts\Utilities\LogLevels::class,
            \Squipix\LaravelLogViewer\Utilities\LogLevels::class,
        ];
    ...
    public function it_can_get_all_logs(): void
    {
        ...
        static::assertInstanceOf(\Squipix\LaravelLogViewer\Entities\LogCollection::class, $logs);
    ...
    {
        $this->expectException(\Squipix\LaravelLogViewer\Exceptions\LogNotFoundException::class);
