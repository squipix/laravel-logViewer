...
use Squipix\LaravelLogViewer\Utilities\LogChecker;
...
class LogCheckerTest extends TestCase
{
    ...
    /** @var  \Squipix\LaravelLogViewer\Utilities\LogChecker */
    private $checker;
    ...
    protected function setUp(): void
    {
        ...
        $this->checker = $this->app->make(\Squipix\LaravelLogViewer\Contracts\Utilities\LogChecker::class);
    }
