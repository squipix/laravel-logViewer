...
use Squipix\LaravelLogViewer\Utilities\LogLevels;
...
class LogLevelsTest extends TestCase
{
    ...
    /** @var  \Squipix\LaravelLogViewer\Utilities\LogLevels  */
    private $levels;
    ...
    public function setUp(): void
    {
        ...
        $this->levels = $this->app->make(\Squipix\LaravelLogViewer\Contracts\Utilities\LogLevels::class);
    }
