...
namespace Squipix\LaravelLogViewer\Tests\Tables;

use Squipix\LaravelLogViewer\Contracts\Table as TableContract;
...
class StatsTableTest extends TestCase
{
    ...
    /** @var  \Squipix\LaravelLogViewer\Tables\StatsTable */
    private $table;
    ...
    public function it_can_get_stats_table_via_log_viewer(): void
    {
        ...
        $logViewer = $this->app->make(\Squipix\LaravelLogViewer\Contracts\LogViewer::class);
    ...
    {
        /** @var  \Squipix\LaravelLogViewer\Contracts\Utilities\Factory  $logFactory */
        $logFactory = $this->app->make(\Squipix\LaravelLogViewer\Contracts\Utilities\Factory::class);
     ...
     *
     * @param  \Squipix\LaravelLogViewer\Contracts\Table  $table
     */
    ...
    {
        return $this->app->make(\Squipix\LaravelLogViewer\Contracts\LogViewer::class);
    }
    ...
    {
        return $this->app->make(\Squipix\LaravelLogViewer\Contracts\Utilities\LogLevels::class);
    }
}
