...
use Squipix\LaravelLogViewer\Contracts\Utilities\Filesystem;
use Squipix\LaravelLogViewer\Entities\Log;
use Squipix\LaravelLogViewer\Entities\LogEntry;
use Squipix\LaravelLogViewer\Entities\LogEntryCollection;
use Squipix\LaravelLogViewer\Helpers\LogParser;
...
abstract class TestCase extends BaseTestCase
{
     ...
     *
     * @param  string                                            $date
     * @param  \Squipix\LaravelLogViewer\Entities\LogEntryCollection  $entries
     */
     ...
     *
     * @param  string                                  $date
     * @param  \Squipix\LaravelLogViewer\Entities\LogEntry  $entry
     */
     ...
     *
     * @return \Squipix\LaravelLogViewer\Utilities\Filesystem
     */
